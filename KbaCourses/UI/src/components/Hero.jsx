...
const Hero = () => {
  return (
    <div>   
            <div className='bg-purple-200 text-purple-950 p-10 rounded shadow-xl flex flex-col items-center justify-center mt-1 text-center'>
            ...
            <div className='bg-purple-200 flex flex-col items-center justify-center my-10 p-10 text-center'>
